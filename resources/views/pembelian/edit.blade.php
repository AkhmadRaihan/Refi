...
<div class="row">
	<div class="col-md-12">
		<div class="card"><br><a href="{{route('pembelian.index') }}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kembali</a>
				...
				<div class="card-body">
        			...
        			<input type="hidden" name="id" value="{{ request()->get('id') }}">
			  		...
			  		<div class="form-group {{ $errors->has('namabarang') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="namabarang" class="form-control" value="{{ $pembelian->namabarang }}"  required>
			  		...
			  		<div class="form-group {{ $errors->has('jenis_barang') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="jenis_barang" class="form-control" value="{{ $pembelian->jenis_barang }}"  required>
                    ...
                    <div class="form-group {{ $errors->has('jumlah_barang') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="jumlah_barang" class="form-control" value="{{ $pembelian->jumlah_barang }}"  required>
                    ...
                    <div class="form-group {{ $errors->has('harga_barang') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="harga_barang" class="form-control" value="{{ $pembelian->harga_barang }}"  required>
			  		...
			  		<div class="form-group {{ $errors->has('total_harga') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="total_harga" class="form-control" value="{{ $pembelian->total_harga }}"  required>
